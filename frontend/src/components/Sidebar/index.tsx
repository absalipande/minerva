    ...
    <div className={sidebarClassNames}>
      <div className='flex h-full w-full flex-col justify-start'>
        ...
        <div className='flex items-center gap-5 border-y-[1.5px] border-zinc-200 px-8 py-4 dark:border-zinc-700'>
          <Image src='https://minerva-s3-images.s3.ap-southeast-1.amazonaws.com/logo.png' alt='Logo' width={40} height={40} />
          <div>
        ...
        <div className='flex w-full items-center'>
          <div className='align-center flex h-9 w-9 justify-center'>
            {!!currentUserDetails?.profilePictureUrl ? (
              <Image
                src={`https://minerva-s3-images.s3.ap-southeast-1.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
          ...
          <button onClick={handleSignOut} className='hidden rounded bg-zinc-800 px-4 py-2 text-xs font-bold text-white hover:bg-zinc-700 md:block'>
            Sign out
          </button>
        </div>
      </div>
